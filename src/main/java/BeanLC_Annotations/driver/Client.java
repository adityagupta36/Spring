package BeanLC_Annotations.driver;

import BeanLC_Annotations.bean.Test;
...
public class Client {
    public static void main(String[] args) throws SQLException {
        ConfigurableApplicationContext cac = new ClassPathXmlApplicationContext("BeanLC_Annotations.xml");
